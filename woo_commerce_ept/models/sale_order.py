...
class SaleOrder(models.Model):
    ...
    customer_phone_number = fields.Char(related="partner_id.phone",store=True)
    ...
    def _prepare_invoice(self):
        ...
        if self.woo_instance_id:
            ...
            invoice_vals.update({'woo_order_id': self.woo_order_id})
            invoice_vals.update({'woo_order_number': self.woo_order_number})
            invoice_vals.update({'woo_trans_id': self.woo_trans_id})
            invoice_vals.update({'payment_gateway_id': self.payment_gateway_id.id})
            invoice_vals.update({'woo_customer_ip': self.woo_customer_ip})
        return invoice_vals
